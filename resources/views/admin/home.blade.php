			...
			<div class="col-md-4 text-center">	
				<div class="card">
					<div class="card-img-top" style="background-color:#009dad; width:100%; min-height:100px;" src="...">
						<div class="cn"><div class="inner"><i class="fa fa-cubes" aria-hidden="true"></i></div></div>
					</div>
			...
			<div class="col-md-4 text-center">	
				<div class="card">
					<div class="card-img-top" style="background-color:#ad9800; width:100%; min-height:100px;" src="...">
						<div class="cn"><div class="inner"><i class="fa fa-line-chart" aria-hidden="true"></i></div></div>
					</div>
					<div class="card-block">
			...
			<div class="col-md-4 text-center">	
				<div class="card">
					<div class="card-img-top" style="background-color:#ad5800; width:100%; min-height:100px;" src="...">
						<div class="cn"><div class="inner"><i class="fa fa-database" aria-hidden="true"></i></div></div>
					</div>
					<div class="card-block">
