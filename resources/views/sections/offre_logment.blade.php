                   ...
                   <div class="row">
                     <div class="col-md-12">
                        ...
                        <div class="card-text ">
                          ...
                          <div class="row">
                              <div class="col-md-12 fbm-tab-sec-title"><i class="fa fa-th-large text-black" aria-hidden="true"></i> STRUCTURE DE L'OFFRE DE LOGEMENT et PROFIL DÉMOGRAPHIQUE</div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                         ...
                         <div class="col-md-3">
                            ...
                            <br>
                            <div class="row">
                              <div class="col-md-12 fbm-tab-sec-title"><i class="fa fa-th-large text-black" aria-hidden="true"></i> REVENUS DES MÉNAGES et PROGRAMMATION PRU</div>
                            </div>
                            <div class="row">
                               <div class="col-md-6">
